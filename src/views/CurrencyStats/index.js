...
import Loader from '../../components/commons/spinnerCycle';

import Navbar from '../../components/features/navbar/navbar';
import Header from '../../components/features/CurrencyStats/Header';
import CurrencySettings from '../../components/features/CurrencyStats/CurrencySettings';
import CurrencyList from '../../components/features/CurrencyStats/List';
// import SingleButton from '../../components/features/UI/Buttons/SingleButton';
...
class CurrencyStats extends Component {
   state = {
      currencyData: [],
      currencies: 'GBP,AUD,CAD,CHF,CZK,EUR,HUF,JPY,ZAR,PLN,RUB,SEK,USD'.split(','),
      baseCurrency: 'EUR',
